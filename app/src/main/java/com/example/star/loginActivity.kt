...
import com.example.star.databinding.ActivityLoginBinding
import com.example.star.signup
import com.example.star.userdisplay
...
class loginActivity : AppCompatActivity() {
    ...
    fun loginwithfirebase(email: String, pass: String) {
        FirebaseAuth.getInstance().signInWithEmailAndPassword(
            ...
            var intent = Intent(applicationContext, userdisplay::class.java)
            startActivity(intent)
